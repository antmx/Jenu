...
// Define LinkspectorJS.Core.Downloader type
LinkspectorJS.Core.Downloader = function (url, onProgress, onLoad, onError, onTimeout) {
	//var self = this;
	this._url = url;
...
LinkspectorJS.Core.Downloader.prototype = {
	Download: function () {
	...
	CreateCorsRequest: function (method, url) {
		...
		if ("withCredentials" in xhr) {
			...
			// Include cookies as part of the request - need to also set remote website's "Access-Control-Allow-Origin" header to the requesting domain e.g. "linkspectorjs.local"
