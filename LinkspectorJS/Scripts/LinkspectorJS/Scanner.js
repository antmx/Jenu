...
// Define LinkspectorJS.Core.Scanner type
LinkspectorJS.Core.Scanner = function (startUrl, resourceLog, updateCallback, contentParser, pageInfoParser) {
	this.StartUrl = new LinkspectorJS.Core.Url(startUrl);
...
LinkspectorJS.Core.Scanner.prototype = {
	...
	ProcessUrl: function (url) {
		...
		try {
			if (resource.LogStatus == "pending") {
				var downloader = new LinkspectorJS.Core.Downloader(
					resource.Url.href,
