...
// Define LinkspectorJS.Core.PageInfoParser type
LinkspectorJS.Core.PageInfoParser = function () {
	this._content = null;
};

LinkspectorJS.Core.PageInfoParser.prototype = {
...
/*debugger;
var parser = new LinkspectorJS.Core.PageInfoParser();
...
+ "<html lang=\"en\" ng-app=\"linkspectorJSApp\">\n"
+ "<head>"
+ "<meta charset=\"utf-8\">\n"
+ "<meta charset2=\"utf-8\" />\n"
...
//+ "<title>LinkspectorJS - a link scanner<\/title>\n"

//+ "<title>\n"
//+"LinkspectorJS - a link scanner<\/title>\n"

//+ "<title>LinkspectorJS - a link scanner\n"
//+ "<\/title>\n"

//+ "<title>\n"
//+ "LinkspectorJS - a link scanner\n"
//+ "<\/title>\n"

+ "<title>\n"
+ "LinkspectorJS - a link \n"
+ "scanner\n"
+ "<\/title>\n"
+ "</head>");
